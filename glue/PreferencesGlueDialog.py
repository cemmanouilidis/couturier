...
class PreferencesGlueDialog(gtk.Dialog):
    __gtype_name__ = "PreferencesGlueDialog"
    preferences = {}
    ...
    def __new__(cls):
        ...
        Returns a fully instantiated PreferencesGlueDialog object.
        """
        builder = get_builder('PreferencesGlueDialog')
        new_object = builder.get_object("preferences_glue_dialog")
    ...
    def finish_initializing(self, builder):
        ...
        and creating a PreferencesGlueDialog object with it in order to
        finish initializing the start of the new PerferencesGlueDialog
        instance.
